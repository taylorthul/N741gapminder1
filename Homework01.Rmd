---
title: "Homework 1 Gapminder Report"
author: "Taylor Thul"
...
The mean life expectancy is `r round(mean(gapminder$lifeExp), digits=2)` years. The standard deviation of life expectancy is `r round(sd(gapminder$lifeExp), digits=2)`, while the median is `r round(median(gapminder$lifeExp), digits=2)`.  The sample size for the life expectancy data is `r round(length(gapminder$lifeExp), digits=2)`. 
...
```
_Hint: Try running lifeExp by year to get median lifeExp for each year._ 
...
My Github account is at [https://github.com/taylorthul](https://github.com/taylorthul) and the repositiory with this homework file is located at [https://github.com/taylorthul/N741gapminder1](https://github.com/taylorthul/N741gapminder1)
